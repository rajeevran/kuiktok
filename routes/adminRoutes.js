...
var commonService = require('../services/apiServices/adminCommonService');
...
api.post('/addUser', function (req, res) {
    var adminData = req.body;
    commonService.addUserService(adminData, req.files, function (response) {
          res.send(response);
    });
});
...
//#endregion
 ...
 //Add edit Rating
  ...
  api.get('/listRating', function (req, res) {
    var adminData = req.query;
    commonService.listRatingService(adminData, function (response) {
         res.send(response);
    });
})
...
api.get('/get-all-field', function (req, res) {
    var adminData = req.params;
